...
import { faFlag, faCrown, faVideo, faRobot } from "@fortawesome/free-solid-svg-icons";
...
interface ChatConversation {
  ...
  owner?: string; // owner for group, but ignore for self/private
}
              ...
              >
                ...
                <div className="flex items-center justify-between px-3 py-2 bg-[#1f2125] border-b border-[#2e3033]">
                  ...
                  <div className="flex items-center gap-3">
                    {/* Hide report/video on self type */}
                    {conv.type !== "self" && (
                      <button
                        type="button"
                        ...
                        onMouseEnter={(e) =>
                          (e.currentTarget as HTMLElement).style.backgroundColor = "#36253d"
                        }
                        onMouseLeave={(e) =>
                    ...
                    {/* Video call button for private chat (now after report button) */}
                    {conv.type === "private" && (
                      <button
                        type="button"
                        className="flex items-center justify-center rounded-full border-none"
                  ...
                  {tabLoading[conv.id] ? (
                    ...
                    <>
                      {conv.type === "group"
                        ...
                        : conv.type === "self"
                        ? (() => {
                            // Custom render cho self chat: mỗi tin có type=self (mình gửi) và type=bot (người khác!)
                                    ...
                                    >
                                      ...
                                      >
                                        <div style={{
                                            ...
                                            alignItems: "center",
                                            marginBottom: 2,
                                            ...(isOutgoing ? { flexDirection: "row-reverse", gap: 4 } : { gap: 4 }),
                                          }}>
                                          {/* Avatar/icon */}
                                          {(m.selfType === "bot") ? (
                                            <span title="Người khác gửi cho bạn">
                                              <span style={{ display: "inline-flex", alignItems: "center", width: 24, height: 24, background: "#262d38", borderRadius: "100%"}}>
                                                <FontAwesomeIcon icon={faRobot} style={{ color: "#bebebe", fontSize: 15, margin: "auto" }} />
                                              </span>
                                            </span>
                                          ) : (
                                            <span title="Bạn">
                                              {myAvatar ? (
                                                ...
                                                <span className="w-6 h-6 flex items-center justify-center bg-blue-500 rounded-full text-white text-xs" style={{minWidth: 24}}>
                                          ...
                                          <span
                                            ...
                                            style={{
                                              color: isOutgoing ? "#60a5fa" : "#a0a0a0"
                                            }}
                                          >
                                            {nameDisplay}
                                          </span>
                        ...
                        : /* default/private */ (() => {
                            ...
                            return conv.messages.map((m, idx) => {
                              ...
                              const isTimeGapFromPrev =
                                idx === 0
                                  ? false
                                  : getMinutesDiff(conv.messages[idx - 1].createdAt, m.createdAt) > 59;
                              ...
                              return (
                                <React.Fragment key={m.id ?? idx}>
                                  ...
                                  >
                                    <div className={`max-w-[85%] flex flex-col ${isOutgoing ? "items-end" : "items-start"}`}>
                                      {(m.senderName ?? "").trim() !== "" && conv.type !== "self" && (
                                        <span
                                          className={
                                            "mb-0.5" +
