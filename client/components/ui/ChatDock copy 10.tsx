...
function fakeFetchGroupSummary(conversationId: string | number): Promise<string> {
  return new Promise(res =>
    setTimeout(() => {
      // Tạm thời ghi cứng, cắt còn tối đa 300 ký tự
      res(
        "Có vẻ như mọi người trong đoạn chat này đang test chức năng gì đó".slice(0, 300)
      );
    }, 1000)
  );
}
              ...
              >
                ...
                <div className="flex items-center justify-between px-3 py-2 bg-[#1f2125] border-b border-[#2e3033]" style={{position: "relative"}}>
                  ...
                  >
                    ...
                    {/* ====== SUMMARIZE BUTTON/POPOVER (Only for group) ====== */}
                    {conv.type === "group" && (
                    ...
                    {/* ===== END AI summarize popover button ===== */}
                  </div>
                    ...
                    <>
                      {conv.type === "group"
                        ...
                        : conv.type === "self"
                          ...
                          : /* default/private */ (() => {
                            // ...PRIVATE DEFAULT LOGIC unchanged...
                            // -- OMITTED for brevity --
                            return null;
                          })()}
                ...
                <div className="border-t border-[#2e3033] px-3 py-2 bg-[#1b1d20]">
                  <div className="flex items-center gap-2">
                    <div className="relative flex-1">
                      ...
                      />
                      {/* Nếu bắt đầu bằng "@ bot" (có dấu cách) thì highlight nền xanh cho cả chữ "@ bot" */}
                      {conv.type === "self" && drafts[conv.id]?.startsWith("@bot ") && (
                        <span
                          className="absolute left-2 top-1/2 -translate-y-1/2 text-[13px] cursor-pointer group select-none"
                          style={{
                            pointerEvents: "auto",
                            whiteSpace: "nowrap",
                          }}
